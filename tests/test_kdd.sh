...
kubectl apply -f /tests/mock_data/kdd/mesh/tprs.yaml > /dev/null 2>&1
kubectl apply -f /tests/mock_data/kdd/mesh/nodes.yaml > /dev/null 2>&1
...
until kubectl apply -f /tests/mock_data/kdd/mesh/tpr_data.yaml > /dev/null 2>&1; do
  sleep 1
done
